...
"""
KidsVoiceAI - Bezpieczny interfejs głosowy AI dla dzieci.

Biblioteka KidsVoiceAI zapewnia narzędzia do tworzenia bezpiecznych
...
from kidsvoiceai.api import SafeAPIConnector, CacheManager
from kidsvoiceai.hardware import HardwareInterface, PowerManager
from kidsvoiceai.safety import ParentalControl, ContentFilter
...
CONFIG_DIR = os.path.expanduser("~/.kidsvoiceai")
...
def initialize_default_configs():
    ...
    system_config = {
        ...
        "stt": {
            "model_path": os.path.expanduser("~/.kidsvoiceai/models/stt/models/ggml-tiny.bin"),
            "language": "pl"
        },
        "tts": {
