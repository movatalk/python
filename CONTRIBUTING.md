...
```bash
git clone https://gitlab.com/movatalk/python.git
cd movatalk
```
...
Przed wysłaniem Pull Requesta, upewnij się, że Twój kod spełnia standardy:

```bash
# Formatowanie kodu
black movatalk tests

# Sprawdzenie stylu kodu
flake8 movatalk tests

# Uporządkowanie importów
isort movatalk tests
...
- GitLab: https://gitlab.com/movatalk/python
